...
JEI.removeAndHide(<vanillafoodpantry:portion_leather>);
...
furnace.setFuel(<vanillafoodpantry:lava_sand_pack>, 0);
furnace.setFuel(<vanillafoodpantry:lava_sand_block>, 2600);
furnace.setFuel(<vanillafoodpantry:lava_sand_portion>, 300);
